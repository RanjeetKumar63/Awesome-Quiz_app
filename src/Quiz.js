...
import { saveQuizResult, getQuizHistory } from "./IndexedDB"; // Import IndexedDB functions
import "./App.css";
...
const Quiz = () => {
  ...
  return (
    <div className="quiz-container">
      <h1 className="tp">Quiz App</h1>
      <h2>Multiple-Choice Questions and Integer-Type Questions (10)</h2>
      <hr />
